...
<style scoped>
  ...
  .content{max-width:6.4rem; margin:0 auto; margin-bottom:0.8rem;margin-top:0.4rem}
  ...
  .header .user-box{width:2.14rem; font-size:0.25rem; color:#fff; margin:0 auto; margin-top:0.1rem; }
