<template>
  ...
  <div class="content">
    ...
    <h2 @click="upload" id="h1">点这传头像</h2>
	<input type="file" name="" id="file" style="display: none;">
	<input type="text" placeholder="设置昵称" id='text'>
    <div class="login-box">
      <p class="lsolid"></p>
      <div class="login"> 
  ...
  export default {
    ...
    methods: {
      reg(){
		...
		fromData.append('nikename',text.value)
...
<style scoped>
  ...
  .content h2{width:2.18rem;height:0.25rem; /* background:url(../assets/img/my_cz.png) no-repeat 0 0; */ background-size:100%; margin:0 auto; margin-top:0.92rem;}
  .content input{
	  border:1px solid skyblue;margin: 0.5rem 1rem;
  }
  .content .login{width:2.0rem;height:0.38rem; margin:0 auto; margin-top:0.5rem;}
